...
class PyramidPoolingTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=3, embed_dims=[64, 128, 320, 512],
...
# model = p2t_small().to('cuda:0')
# print(model(torch.randn(16,3,512,512).to('cuda:0')).shape)